...
namespace LKMT.GUI
{
    public partial class fLoaiSP : UserControl
    {
        ...
        private void dgvLoaiSP_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (selectedRowCount >= 1)
            {
                if (e.RowIndex != -1)
                {
                    ...
                    txtNgayTao.Text = (!string.IsNullOrEmpty(row.Cells[3].Value.ToString()) ? DateTime.Parse(row.Cells[3].Value.ToString()).ToString("yyyy/MM/dd") : DateTime.Now.ToString("yyyy/MM/dd"));
                    txtCapNhat.Text = (!string.IsNullOrEmpty(row.Cells[4].Value.ToString()) ? DateTime.Parse(row.Cells[4].Value.ToString()).ToString("yyyy/MM/dd") : DateTime.Now.ToString("yyyy/MM/dd"));
                }
            }
        }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng chọn loại sản phẩm muốn cập nhật!!", "Thông Báo", MessageBoxButtons.OK);
            }
        }
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else MessageBox.Show("Thêm loại sản phẩm thất bại!!", "Thông Báo", MessageBoxButtons.OK);
            }
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (selectedRowCount > 0)
            {
                ...
                else MessageBox.Show("Xóa loại sản phẩm thất bại!!", "Thông Báo", MessageBoxButtons.OK);
            }
            else
            {
                MessageBox.Show("Vui lòng chọn loại sản phẩm muốn xóa!!", "Thông Báo", MessageBoxButtons.OK);
            }
        }
