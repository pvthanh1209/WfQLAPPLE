...
namespace BUS
{
    public class ThanhToanBUS
    {
        ...
        public void showListThanhToan(ComboBox cbo)
        {
            cbo.DataSource = DAO.ThanhToanDAO.Instance.getListThanhToan();
            cbo.ValueMember = "id_thanhtoan";
            cbo.DisplayMember = "tenthanhtoan";
        }
    }
}
