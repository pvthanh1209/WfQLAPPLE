...
namespace BUS
{
    public class LoaiSanPhamBUS
    {
        ...
        {
            var result = from a in DAO.LoaiSanPhamDAO.Instance.getLoaiSP() select new { id_loai = a.id_loai, tenloai = a.tenloai, id_nhom = a.id_nhom, ngaytao = a.ngaytao, ngaycapnhat = a.ngaycapnhat};
            data.DataSource = result.ToList();
        }
        public void showListLoaiSP(DataGridView data, ComboBox cboNhomSP)
        {
            List<LoaiSPModel> list = new List<LoaiSPModel>();
